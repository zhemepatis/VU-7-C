\section{Duomenų aibės kūrimas}
    ...
    \subsection{Dirbtinis duomenų generavimas}
        ...
        Šiame darbe duomenys buvo generuojami dirbtinai, pasitelkiant sferos, ... etalono funkcijas (angl. \textit{benchmark functions}).

        \input{skyriai/duomenu_aibes_kurimas/duomenu_generavimas/sferos_funkc}
    ...
    \subsection{Triukšmo duomenų aibei pritaikymas}
        ...
        \input{skyriai/duomenu_aibes_kurimas/triuksmo_pridejimas/gauso_skirstinio_metodas}