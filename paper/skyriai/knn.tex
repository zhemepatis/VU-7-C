\section{K artimiausių kaimynų metodas}
    ...
    K artimiausių kaimynų (angl.~\textit{K Nearest Neighbors}) metodas yra vienas paprasčiausių prižiūrimo mokymosi (angl.~\textit{supervised learning}) algoritmų. Jis yra grindžiamas sprendimų priėmimu, remiantis artimiausiai esančių taškų informacija.
