    ...
    \begin{itemize}
        \item Rezultatai su švariais duomenim:
            ...
            \begin{itemize}
                ...
                \item $k$ artimiausių kaimynų metodo modeliai rodė stabilesnį rodiklių gerėjimą didinant duomenų aibės dydį;
                \item dirbtinio neuroninio tinklo atveju rodiklių pokyčiai buvo nestabilūs, kai kuriais atvejais stebėtas jų pablogėjimas.
            \end{itemize}
        
        \item Rezultatai su triukšmingais duomenim:
            
            \begin{itemize}
                \item visais nagrinėtais atvejais dirbtinio neuroninio tinklo modelis pasižymėjo geresniais prognozavimo rezultatais nei $k$ artimiausių kaimynų metodo modeliai;
                \item $k$ artimiausių kaimynų metodo atveju buvo nustatyta, kad didėjant mokymo duomenų aibės dydžiui, modelio tikslumas augo nuosekliai ir panašiu tempu.
            \end{itemize}
