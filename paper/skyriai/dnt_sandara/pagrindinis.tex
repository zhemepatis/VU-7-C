...
\label{skr:dnt_sandara}
    ...
    \label{skr:neuronai}
        ...
        \input{skyriai/dnt_sandara/svertine_suma}
        ...
        \label{skr:aktyvavimo_funkc}
            ...
            \input{skyriai/dnt_sandara/aktyvavimo_funkc/sigmoidine}
            \input{skyriai/dnt_sandara/aktyvavimo_funkc/hiperbolinio_tangento}
            \input{skyriai/dnt_sandara/aktyvavimo_funkc/relu}
    ...
    \label{skr:sluoksniai}
        ...
        \input{skyriai/dnt_sandara/sluoksniai/ivesties}
        \input{skyriai/dnt_sandara/sluoksniai/isvesties}
        \input{skyriai/dnt_sandara/sluoksniai/pasleptasis}
