    ...
    \subsection{Triukšmo duomenų aibei pritaikymas}
        ...
        \subsubsection{Gauso skirstinio metodas}
            ...
            \begin{figure}[H]
                ...
                \caption{Švarių ir duomenų su triukšmu sugretinimas ($\mu = 0$, $\sigma = 0,5$)}
            ...
            \begin{figure}[H]
                ...
                \caption{Švarių ir duomenų su triukšmu sugretinimas ($\mu = 0$, $\sigma = 1,5$)}
                \label{pav:triuksmo_ir_svariu_duomenu_sugretinimas_1}
            \end{figure}

        \subsubsection{Druskos ir pipirų metodas}

        \subsubsection{Išlyginimo metodas}
