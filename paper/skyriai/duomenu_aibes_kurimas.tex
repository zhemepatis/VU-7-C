\section{Duomenų aibės kūrimas}
    ...
    \subsection{Dirbtinis duomenų generavimas}
        ...
        Duomenų generavimui yra naudojamos etalono (angl.~\textit{benchmark}) funkcijos. Jų yra daugybė, todėl žemiau yra paminėtos tik kelios dažniausiai naudojamos funkcijos (\ref{eq:sferos_etalono_funkc}, \ref{eq:rastrigin_etalono_funkc} ir \ref{eq:griewank_etalono_funkc} formulės).
