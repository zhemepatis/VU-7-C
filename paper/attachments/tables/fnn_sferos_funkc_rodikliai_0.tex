\begin{table}[H]
    ...
    \caption{Dirbtinio neuroninio tinklo absoliutinės paklaidos statistiniai rodikliai nagrinėjant sferos funkciją}
    \label{lnt:fnn_sferos_funkc_paklaidos_rodikliai}
\end{table}
