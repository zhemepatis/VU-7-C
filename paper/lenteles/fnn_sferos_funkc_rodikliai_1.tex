\begin{table}[H]
    ...
    \caption{Dirbtinio neuroninio tinklo absoliutinės paklaidos statistiniai rodikliai nagrinėjant sferos funkciją su triukšmu}
    \label{lnt:fnn_sferos_funkc_rodikliai_1}
\end{table}
