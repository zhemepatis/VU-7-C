\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|}
        ...
        10 000 000 & $<10^{-6}$ & 3,839611 & 0,538008 & 0,413742 \\ \hline
    \end{tabular}
    
    \caption{$K$ artimiausių kaimynų metodo rezultatai su švariais duomenim (k = 1).}
    \label{tbl:nn_sferos_funkc_svarus}
\end{table}
