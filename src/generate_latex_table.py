...
if __name__ == "__main__":
    ...
    for _, row in filtered.iterrows():
        ...
        min_str  = format_value(row["Absolute error min"])
        max_str  = format_value(row["Absolute error max"])
        mean_str = format_value(row["Absolute error mean"])
        std_str  = format_value(row["Absolute error std. deviation"])
